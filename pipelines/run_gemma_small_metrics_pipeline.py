"""
Gemma-4-E2B Dense Metrics Pipeline
====================================
"""
...
def run_evaluation(
    ...
    print(f"✅ Perplexity: {perplexity:.2f}, Saved to: {parquet_path}")
    return {
...
def run_pipeline(config: Dict):
    print("=" * 70)
    print(f"GEMMA DENSE METRICS PIPELINE")
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python run_gemma_small_metrics_pipeline.py <config_file.json>")
        sys.exit(1)
