...
from internal_logging.moe_internal_logging_gemma import RouterLogger
...
def run_pipeline(config: Dict):
    print("=" * 70)
    print(f"GEMMA 4 MOE METRICS PIPELINE")
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python run_gemma_metrics_pipeline.py <config_file.json>")
        sys.exit(1)
