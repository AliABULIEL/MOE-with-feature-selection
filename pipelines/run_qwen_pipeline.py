...
# Import the existing RouterLogger from internal_logging/moe_internal_logging_qwen.py
from internal_logging.moe_internal_logging_qwen import RouterLogger, InternalRoutingLogger
