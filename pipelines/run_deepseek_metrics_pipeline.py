"""
DeepSeek-V2-Lite MoE Metrics Pipeline
====================================
"""
...
from internal_logging.moe_internal_logging_deepseek import RouterLogger
...
def run_pipeline(config: Dict):
    print("=" * 70)
    print(f"DEEPSEEK MOE METRICS PIPELINE")
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python run_deepseek_metrics_pipeline.py <config_file.json>")
        sys.exit(1)
